...
public class OrdenParticipanteATerceroT5 extends ServicioBaseGenerarOrden{
    public OrdenParticipanteATerceroT5() throws IOException {
        super.inicializarDatos();
        datosOrdenes.setTipoPago(5);
    }

    @Override
    protected String generarPeticion(DatosOrdenes datos) {
        datosOrdenes.setClaveRastreo("PagoT5SPEI3QA" + (System.currentTimeMillis() % 100000));
    ...
    protected String generarFirma(DatosOrdenes datos) {
        return new CryptoHandler().ordenParticipanteATerceroT5(datosOrdenes);
    }
}
