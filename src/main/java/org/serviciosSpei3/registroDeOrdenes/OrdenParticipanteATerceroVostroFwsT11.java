...
public class OrdenParticipanteATerceroVostroFwsT11 extends ServicioBaseGenerarOrden{
    public OrdenParticipanteATerceroVostroFwsT11() throws IOException {
        super.inicializarDatos();
        datosOrdenes.setTipoPago(11);
    }

    @Override
    protected String generarPeticion(DatosOrdenes datos) {
        datosOrdenes.setClaveRastreo("PagoT11SPEI3QA" + (System.currentTimeMillis() % 100000));
    ...
    protected String generarFirma(DatosOrdenes datos) {
        return new CryptoHandler().ordenParticipanteATerceroVostroFwsT11(datosOrdenes);
    }
}
